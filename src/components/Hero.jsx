...
function Hero() {
  ...
  <div className="order-2 md:order-1 "  >
    ...
    <h3 className='font-bebasl font-extralight text-[#E7CEB0] text-[1.2rem] md:tex '>Web Development</h3>
    <h3 className='font-bebasl font-extralight text-[#E7CEB0] text-[1.2rem] md:tex '>Intellegent Systems</h3>
    <h3 className='font-bebasl font-extralight text-[#E7CEB0] text-[1.2rem] md:tex '>ML Models</h3>
